...
- **Yang Dibutuhkan:**
  - Cluster Kubernetes yang sudah jalan. Jika belum ada, bisa melihat di [ dokumentasi instalasi kubernetes ini ]( https://github.com/elangptra/dokumentasi-kubernetes/blob/main/Instalasi-kubernetes-3-node-cluster.md ).
